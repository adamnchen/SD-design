...
CREATE TABLE `sd_presale_project`  (
  ...
  `proofing_invitation_id` bigint NULL DEFAULT NULL COMMENT '关联的打样邀请ID',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1980551518319284227 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '批量订单项目主表' ROW_FORMAT = DYNAMIC;
