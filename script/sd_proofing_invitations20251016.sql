...
) ENGINE = InnoDB AUTO_INCREMENT = 1978639979110731778 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '作品打样合作邀请记录表' ROW_FORMAT = Dynamic;
