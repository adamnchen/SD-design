...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '邀约候选厂家报价表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sd_proofing_invitations`  (
  ...
  `work_id` bigint UNSIGNED NOT NULL COMMENT '发起邀约的作品ID，关联作品表',
  ...
  `status` tinyint NOT NULL DEFAULT 0 COMMENT '邀约状态 (0: 待处理, 1: 已接受, 2: 已拒绝, 3: 已取消)',
  ...
  INDEX `idx_invitee_user_id`(`invitee_user_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1975859099199979523 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '作品打样合作邀请记录表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1975842424450723843 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '用户自定义标签表' ROW_FORMAT = Dynamic;
