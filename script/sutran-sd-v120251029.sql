...
CREATE TABLE `sd_crowdfunding_project`  (
  ...
  `designer_photos` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '设计师上传的实物照片（JSON格式，多张图片）',
  ...
  INDEX `idx_sd_crowdfunding_project_designer_upload_time`(`designer_upload_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1980921079354884098 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '众筹项目主表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sd_crowdfunding_sample_delivery`  (
  ...
  `delivery_status` tinyint NULL DEFAULT 1 COMMENT '状态：1=中奖待发货，2=已发货',
...
CREATE TABLE `sd_crowdfunding_support`  (
  ...
  `update_by` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '更新者',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  `status` int NULL DEFAULT 0 COMMENT '支持状态：0=正常，1=已取消，2=已退款',
  `refund_time` datetime NULL DEFAULT NULL COMMENT '退款时间',
  ...
  INDEX `idx_crowdfunding_support_status`(`status` ASC) USING BTREE,
  INDEX `idx_crowdfunding_support_refund_time`(`refund_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 101 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '众筹支持记录表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `sd_flow`  (
  ...
  `draw_num` int NULL DEFAULT 1 COMMENT '初始生图数量',
  ...
  INDEX `is_fixed`(`is_fixed` ASC) USING BTREE
...
CREATE TABLE `sd_presale_order`  (
  ...
  INDEX `idx_delivery_status`(`delivery_status` ASC) USING BTREE,
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1981194437015384067 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '批量订单表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `sd_presale_project`  (
  ...
  INDEX `idx_delivery_status`(`delivery_status` ASC) USING BTREE,
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1981174464092143618 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '批量订单项目主表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `sd_proofing_invitation_candidates`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_invitation_invitee`(`invitation_id` ASC, `invitee_user_id` ASC) USING BTREE,
  INDEX `idx_invitation_id_status`(`invitation_id` ASC, `status` ASC) USING BTREE,
  INDEX `idx_invitee_user_id`(`invitee_user_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1981607102149914626 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '邀约候选厂家报价表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sd_proofing_invitations`  (
  ...
  INDEX `idx_invitee_user_id`(`invitee_user_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1981606897258164226 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '作品打样合作邀请记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sd_user_normal_point`  (
  ...
  `proofing_point` int NOT NULL DEFAULT 0 COMMENT '打样积分',
  `priifing_level` int NULL DEFAULT 0 COMMENT '打样荣誉等级',
  `sale_point` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '0' COMMENT '销售积分',
  `sale_level` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '0' COMMENT '销售荣誉等级',
  PRIMARY KEY (`user_id`, `proofing_point`) USING BTREE
...
CREATE TABLE `sys_user`  (
  ...
  `biz_type` tinyint UNSIGNED NOT NULL DEFAULT 2 COMMENT '用户身份类型：0=厂商和设计师，1=设计师，2=普通用户',
...
CREATE TABLE `sys_user_tag`  (
  ...
  `biz_type` tinyint UNSIGNED NOT NULL DEFAULT 3 COMMENT '身份标签为0厂商和设计师，1设计师，2普通用户和业务标签3，身份标签由系统分配',
  ...
  INDEX `idx_user_id`(`user_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1980182154302779394 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '用户自定义标签表' ROW_FORMAT = Dynamic;
