...
CREATE TABLE `sys_user_tag`  (
  ...
  `biz_type` tinyint UNSIGNED NOT NULL DEFAULT 1 COMMENT '业务类型：1=身份/能力标签',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '用户自定义标签表' ROW_FORMAT = Dynamic;
