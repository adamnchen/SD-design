package com.sutran.sd.controller.web.monitor;
...
import com.sutran.sd.system.domain.SysCache;
...
public class CacheController {
    ...
    static {
        ...
        CACHES.add(new SysCache(CacheConstants.CHECK_POINT, "当前使用大模型"));
        CACHES.add(new SysCache(CacheConstants.TRAIN_TAG_TRANSLATE_MAP, "SD翻译标签"));
        CACHES.add(new SysCache(CacheConstants.TRAIN_ADDITION_LIST, "SD共性词数组"));
    }
