package com.sutran.sd.web.controller.system;
...
public class SysSdController extends BaseController {
    ...
    /**
     * [后台接口]SD Lora模型-查询列表(模型关联的测试任务、xyz数据)
     */
