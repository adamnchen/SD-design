...
public class AuthV3Util {
     ...
     */
    public static void addAuthParams(String appKey, String appSecret, Map<String, String> paramsMap) throws NoSuchAlgorithmException {
        String salt = UUID.randomUUID().toString();
        String curtime = String.valueOf(System.currentTimeMillis() / 1000);
        String sign = calculateSign(appKey, appSecret, paramsMap.get("q"), salt, curtime);
