package com.sutran.sd.framework.exception;
...
public class GlobalExceptionHandler {
    ...
    public R<Void> handleNotLoginException(NotLoginException e, HttpServletRequest request) {
        String requestURI = request.getRequestURI();
        if (StrUtil.isNotEmpty(e.getMessage()) && !e.getMessage().contains("已被顶下线")) {
    ...
    public R<Object> handleServiceException(ServiceException e, HttpServletRequest request) {
        ...
        return ObjectUtil.isNotNull(code) ? R.fail(code, e.getMessage(), data) : R.fail(e.getMessage(),data);
    }
