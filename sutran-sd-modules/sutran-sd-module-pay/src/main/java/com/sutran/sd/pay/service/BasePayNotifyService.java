...
public abstract class BasePayNotifyService {
     ...
     * @return 处理结果
     */
    public String handleNotify(HttpServletRequest request, AliPayApiConfig aliPayConfig) {
        try {
            // 获取支付宝POST过来反馈信息
            ...
            if (verifyResult) {
                ...
                return handleBusiness(tradeStatus, outTradeNo, tradeNo, totalAmount, gmtPayment, aliPayConfig);
            }
            else {
