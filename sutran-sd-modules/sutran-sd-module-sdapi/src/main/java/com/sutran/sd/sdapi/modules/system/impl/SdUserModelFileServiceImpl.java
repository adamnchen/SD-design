...
import com.sutran.sd.sdapi.modules.system.SdUserModelFileService;
...
@Slf4j
@Service("SdUserModelFileService")
public class SdUserModelFileServiceImpl implements SdUserModelFileService {

    @Resource
    private SdUserModelFileMapper baseMapper;
    @Resource
    private SdUserModelMapper sdUserModelMapper;
    @Resource
