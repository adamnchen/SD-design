...
import com.sutran.sd.sdapi.mapper.SdUserMsgMapper;
...
import static com.sutran.sd.sdapi.mq.MqConstant.WX_MSG_QUEUE;
...
public class SdUserMsgServiceImpl implements SdUserMsgService {
    ...
    @RabbitListener(queues = WX_MSG_QUEUE)
