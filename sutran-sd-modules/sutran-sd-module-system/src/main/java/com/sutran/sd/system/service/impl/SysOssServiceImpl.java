...
import com.sutran.sd.oss.enumd.AccessPolicyType;
...
import com.sutran.sd.system.mapper.SysOssMapper;
...
public class SysOssServiceImpl implements ISysOssService, OssService {
    ...
    @Override
    public void insertOssData(String originalfileName, String suffix, String configKey, String url, String filename, String userName) {
        SysOss oss = new SysOss();
        oss.setUrl(url);
        oss.setFileSuffix(suffix);
        oss.setFileName(filename);
        oss.setOriginalName(StrUtil.isEmptyIfStr(originalfileName)?filename:originalfileName);
        oss.setService(configKey);
        oss.setCreateBy(userName);
